export default {
  ...
  "Elasticsearch": [
    ...
    },
    {
      ...
      book_id: "en/elasticsearch/resiliency"
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          book_id: "en/elasticsearch/client/java-rest"
        },
        {
  ...
  "Legacy documentation": [
    ...
    },
    {
      ...
      book_id: "en/infrastructure/guide"
    },
    {
      title: "Stack Overview",
      book_id: "en/elastic-stack-overview"
    },
    {
    ...
    },
    {
      ...
      book_id: "en/elasticsearch/guide"
    },
    {
    ...
    {
      title: "Groovy API",
      book_id: "en/elasticsearch/client/groovy-api"
    },
    {
      title: "Topbeat Reference",
      book_id: "en/beats/topbeat"
    },
    {
      title: "Elasticsearch.js for 5.6-7.6",
      book_id: "en/elasticsearch/client/elasticsearch-js"
    },
    {
      title: "简体中文",
      book_id: "cn",
      items: [
        {
          ...
          book_id: "cn/elasticsearch/guide"
        },
        {
          title: "PHP API",
          book_id: "cn/elasticsearch/php"
        },
        {
          title: "Kibana 用户手册",
          book_id: "cn/kibana"
      ...
      items: [
        {
          ...
          book_id: "jp/elasticsearch/reference"
        },
        {
      ...
      items: [
        {
          ...
          book_id: "kr/elasticsearch/reference"
        },
        {
          title: "Logstash 참조",
          book_id: "kr/logstash"
  ...
  "Docs in Development": [
    {
      ...
      book_id: "en/logstash-kubernetes"
    }
  ]
}
